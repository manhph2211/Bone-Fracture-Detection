...
data = dict(
    train=dict(
        img_prefix='../data/original/dataDetect_train/',
        classes=classes,
        ann_file='../data/original/dataDetect_train/train_data_coco.json'),
    val=dict(
        img_prefix='../data/original/dataDetect_test',
        classes=classes,
        ann_file='../data/original/dataDetect_test/test_data_coco.json'),
   )
